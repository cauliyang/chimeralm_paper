...
\begin{tikzpicture}[node distance=1cm, every node/.style={transform shape}]
	...
	% Arrows from data sources to comparison engine
	\draw[arrow] (mdachimeric.east) to[out=0,in=180,looseness=0.8] (compengine.west);
	\draw[arrow] (bulkchimeric1.south) to[out=270,in=70,looseness=1.0] (compengine.north west);
	\draw[arrow] (bulkchimeric2.south) to[out=270,in=60,looseness=0.8] (compengine.north);
	\draw[arrow] (bulkchimeric3.south) to[out=270,in=60,looseness=1.0] (compengine.north east);

	% Classification arrows from comparison engine to support groups
	\draw[arrow] (compengine.south) to[out=200,in=90,looseness=0.8] (sup0.north);
	...
	\draw[arrow] (compengine.south) to[out=340,in=90,looseness=0.8] (sup3.north);
