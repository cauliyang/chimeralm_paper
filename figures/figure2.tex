...
\begin{tikzpicture}[
	...
	\node[tsgformat, below=4.6cm of caller] (tsg) {TSG Format};
	\node[coreengine, right=8.5cm of tsg] (tsgtools) {tsgtools (Rust) \\ Core Engine};
	...
	% Add small connecting lines from bracket to each feature
	% \draw[line width=1.5pt, color=naturered] 
	% 	([yshift=-0.3cm]conv.north) -- ++(0,0.3);
	% \draw[line width=1.5pt, color=naturered] 
	% 	([yshift=-0.3cm]analysis.north) -- ++(0,0.3);
	% \draw[line width=1.5pt, color=naturered] 
	% 	([yshift=-0.3cm]query.north) -- ++(0,0.3);
