...
\begin{tikzpicture}[
    ...
    \node[feature, below=2cm of outputgroup] (conv) {Format Conversion};
    ...
    % Ecosystem boundary box with enhanced styling
    \node[ecosystembox, fit={(tsg) (python) (tsgtools) (aurora) (conv) (analysis) (query)},
        label={[label]below left:TSG Ecosystem}] (ecosystem) {};
