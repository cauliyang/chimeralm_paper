...
This labeling procedure classified 12,963,576 chimeric reads from the \gls{wga} PromethION dataset into two groups based on bulk support (Extended Data Fig.~\ref{fig:data_construction}b). 
