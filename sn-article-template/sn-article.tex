...
This inversion‑heavy signature mirrors previous observations from single‑cell long‑read sequencing using PacBio and droplet‑based \gls{mda}~\cite{hard2023longread}, suggesting that many of these events arise from amplification‑induced chimeras rather than genuine genomic rearrangements.
