...
ChimeraLM reduced chimeric reads by ${\sim}90$\% on both platforms, substantially outperforming CADECT(8.3\% and 4.6\% reduction on PromethION and MinION, respectively), while 3rd-ChimeraMiner showed no detectable reduction.
